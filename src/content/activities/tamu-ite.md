...
<div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6 grid-portrait">
  <img class="rounded-xl border border-white/10 shadow-lg" src="/assets/general_meeting.jpg" alt="ITE General Meeting Poster">
  <img class="rounded-xl border border-white/10 shadow-lg" src="/assets/annual_report.png" alt="TamuITE Annual Report Design">
</div>
